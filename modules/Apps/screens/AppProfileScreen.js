...
const mock = {
  ...
  p2: '这是一个去中心化的复利MMM，没有任何中心机构，所有的游戏规则都以智能合约的方式，写在以太坊网。并自动执行。\n \n' +
   '去中心化的复利MMM是建立在Genesis space理想国APP开发的小程序，在这里所有的参与和提现都是通过NES来实现。',
  p3: '这是一个去中心化的复利MMM，没有任何中心机构，所有的游戏规则都以智能合约的方式，写在以太坊网。并自动执行。\n' +
    '\n' +
    '去中心化的复利MMM是建立在Genesis space理想国APP开发的小程序，在这里所有的参与和提现都是通过NES来实现。\n' +
    '\n' +
    ...
    return <ScrollView style={styles.container}>
      <View style={styles.introContainer}>
        <View style={styles.imageContainer}>
          ...
          />
          <TouchableOpacity style={styles.getButton} onPress={()=>{showPopup(aboutInfo.todo)}}>
