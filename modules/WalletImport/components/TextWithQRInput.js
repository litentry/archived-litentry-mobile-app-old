...
import {Clipboard, Platform, SafeAreaView, StyleSheet, Text, TextInput, TouchableOpacity, View, Dimensions} from 'react-native';
...
class TextWithQRInput extends React.Component {
  ...
  onImportSuccess = () => {
    const { unUnlock, nextScreen, navigation} = this.props
