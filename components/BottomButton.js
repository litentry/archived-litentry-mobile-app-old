...
import { Animated, Text, StyleSheet, TouchableOpacity, Keyboard, Platform } from 'react-native';
...
export default class BottomButton extends Component {
  ...
  _runKeyboardAnim(toValue) {
    ...
    Animated.parallel([
      ...
      Animated.timing(this.state.marginVertical, {
  ...
  render() {
    ...
    return (
      <Animated.View
        ...
        <TouchableOpacity disabled={disable} onPress={this.onPress} style={styles.saveButton}>
          <Text
            style={{
              fontSize: 16,
              color: disable ? AppStyle.secondaryTextColor : AppStyle.mainColor,
